...
export function App() {
  const { rearranging, toggleRearranging, filters, setFilters, ...gridProps } = useWidgetGrid();
      ...
      <YStack gap={4}>
        <XStack justify="space-between" align="center">
          ...
          <XStack gap={2} align="center">
            <Button variant="primary" onClick={gridProps.onAddWidget}>
              + Add widget
            </Button>
        ...
        <WidgetGrid rearranging={rearranging} filters={filters} {...gridProps} />
      </YStack>
    </main>
  );
}
